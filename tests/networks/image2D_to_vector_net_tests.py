...
class TestImage2DToVectorNet(unittest.TestCase):
    ...
    def test_Image2DToVectorNet_init(self):
        """Test initialization"""
    ...
    def test_Image2DToVectorNet_get_input_shape(self):
    ...
    def test_Image2DToVectorNet_init_filters_res_shapes(self):
    ...
    def test_Image2DToVectorNet_filters_per_block_shapes(self):
        """Test for intermediate shapes"""
