...
def generate_slice_png(model_path,
                       actin_model_dirs,
                       nuclei_model_dirs,
                       input_chan_names,
                       target_chan_names,
    ...
    for actin_model_dir, nuclei_model_dir, input_channel_name in \
        ...
        # config_name = os.path.join(model_path, actin_model_dir, 'config.yml')
        ...
        for model_dir, pred_target_chan_name in zip([nuclei_model_dir, actin_model_dir], pred_target_chan_names):
            pred_path = os.path.join(model_path, model_dir, 'predictions', 'figures')
            tiff_file_name = 'orthogonal_view_p{}.png'.format(pos_idx)
            im_pred = read_img(pred_path, tiff_file_name, tol=tol)
...
if __name__ == '__main__':
    ...
    input_image_path = '/CompMicro/Projects/virtualstaining/kidneyslice/' \
                 '2019_02_15_kidney_slice/SMS_2018_1227_1433_1_SMS_2018_1227_1433_1/2-Pos_002_026'
    ...
    input_chan_names = ['Retardance', 'Orientation', 'Brightfield', 'Polarization',
